...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<span><span class="icon icon-chevron-left text-transparent"></span></span>');
            var $nextMonthNavIcon = $('<span><span class="icon icon-chevron-right text-transparent"></span></span>');
